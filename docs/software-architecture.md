...
1. A member searches authenticated profiles and sends a request.
2. The recipient accepts or declines the request.
3. Accepted friends can view collection cards and available duplicates.
4. Daily snapshots remain private to their owner.
